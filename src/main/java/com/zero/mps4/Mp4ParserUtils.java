...
public class Mp4ParserUtils {
	...
	public static String mergeVideo(List<String> videoList, File mergeVideoFile) {
		...
		try {
			...
			FileChannel fileChannel = new RandomAccessFile(String.format("/Users/caofengnian/Downloads/222.mp4"), "rw").getChannel();
			out.writeContainer(fileChannel);// 将容器内容写入磁盘
			fileChannel.close();
	...
	public static void main(String[] args) {
		List<String> list = Lists.newArrayList("/Users/caofengnian/Downloads/1614237975770027.mp4",
				"/Users/caofengnian/Downloads/1614237975770027.mp4");
		File file = new File("/111.mp4");
